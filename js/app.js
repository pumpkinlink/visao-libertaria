    ...
    for (var j = 0; j < element.childNodes.length; j++) {
      ...
      if (node.nodeType === 3) {
        ...
        var replacedText = text
          ...
          .replace(/\b1\sreal\b/gi, "1 papelzinho colorido")
          .replace(/\bum\sreal\b/gi, "um papelzinho colorido")
          .replace(/\b(\d|mil|milh(?:ão|ões)\sde|bilh(?:ão|ões)\sde|trilh(?:ão|ões)\sde)(\s)reais\b/gi, "$1$2papeizinhos coloridos")
